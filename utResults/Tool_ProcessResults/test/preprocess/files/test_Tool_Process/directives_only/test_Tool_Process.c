# 0 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
# 0 "<built-in>"
#define __STDC__ 1
# 0 "<built-in>"
...
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
# 1 "utExecutionAndResults/utUnderTest/src/Tool.h" 1
/**
 * \file Tool.h
...
# 15 "utExecutionAndResults/utUnderTest/src/Tool.h" 2
...
# 16 "utExecutionAndResults/utUnderTest/src/Tool.h" 2
...
/** @} */
# 2 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 2
# 1 "utExecutionAndResults/utUnderTest/src/Tool_Process.h" 1
# 1 "utExecutionAndResults/utUnderTest/src/Tool.h" 1
/**
 * \file Tool.h
 * \brief Tool module public interface.
...
/** @} */
# 2 "utExecutionAndResults/utUnderTest/src/Tool_Process.h" 2

void Tool_Process(void);
# 3 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Tool_Process/mock_Tool.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Tool_Process/mock_Tool.h" 2
...
# 4 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 2
...
# 7 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 2
...
void test_Tool_Process_WhenRunModeWithData_ProcessesBuffer2(void) {
  ...
  Tool_AssertStateAndBuffer(Tool_modeRun_e, 1U, 0U, 0U, 0U, l_Buffer_u8, TOOL_BUFFER_SIZE_U32);
}
...
void test_Tool_Process_WhenNotRunModeWithData_ProcessesBuffer2(void) {
  ...
  Tool_AssertStateAndBuffer(Tool_modeIdle_e, 1U, 0U, 0U, 0U, l_Buffer_u8, TOOL_BUFFER_SIZE_U32);
}
...
void test_Tool_Process_WhenNotRunModeWithNoData_ProcessesBuffer2(void) {
  ...
  Tool_AssertStateAndBuffer(Tool_modeIdle_e, 0U, 0U, 0U, 0U, l_Buffer_u8, TOOL_BUFFER_SIZE_U32);
}
...
void test_Tool_Process_WhenRunModeWithNoData_ProcessesBuffer2(void) {
  ...
  Tool_AssertStateAndBuffer(Tool_modeRun_e, 0U, 0U, 0U, 0U, l_Buffer_u8, TOOL_BUFFER_SIZE_U32);
}

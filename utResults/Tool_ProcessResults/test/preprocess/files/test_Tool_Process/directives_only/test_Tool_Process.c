...
#define ModuleName_FunctionEx__ExpectAndReturn(in_id_u32, in_mode_e, in_cfg_pcu8, in_buf_pu8, in_bufLen_u16, out_status_pu8, cmock_retval)                                                             \
  ModuleName_FunctionEx__CMockExpectAndReturn(__LINE__, in_id_u32, in_mode_e, in_cfg_pcu8, in_buf_pu8, in_bufLen_u16, out_status_pu8, cmock_retval)
...
typedef uint8_t (*CMOCK_ModuleName_FunctionEx__CALLBACK)(uint32_t in_id_u32, int32_t in_mode_e, const uint8_t *in_cfg_pcu8, uint8_t *in_buf_pu8, uint16_t in_bufLen_u16, uint8_t *out_status_pu8,
                                                         int cmock_num_calls);
...
#define ModuleName_FunctionEx__ExpectWithArray(in_id_u32, in_mode_e, in_cfg_pcu8, in_cfg_pcu8_Depth, in_buf_pu8, in_buf_pu8_Depth, in_bufLen_u16, out_status_pu8, out_status_pu8_Depth)                \
  TEST_FAIL_MESSAGE("ModuleName_FunctionEx_ requires _ExpectWithArrayAndReturn");
#define ModuleName_FunctionEx__ExpectWithArrayAndReturn(in_id_u32, in_mode_e, in_cfg_pcu8, in_cfg_pcu8_Depth, in_buf_pu8, in_buf_pu8_Depth, in_bufLen_u16, out_status_pu8, out_status_pu8_Depth,       \
                                                        cmock_retval)                                                                                                                                  \
  ModuleName_FunctionEx__CMockExpectWithArrayAndReturn(__LINE__, in_id_u32, in_mode_e, in_cfg_pcu8, (in_cfg_pcu8_Depth), in_buf_pu8, (in_buf_pu8_Depth), in_bufLen_u16, out_status_pu8,                \
                                                       (out_status_pu8_Depth), cmock_retval)
...
#define ModuleName_FunctionEx__ReturnArrayThruPtr_out_status_pu8(out_status_pu8, cmock_len)                                                                                                            \
  ModuleName_FunctionEx__CMockReturnMemThruPtr_out_status_pu8(__LINE__, out_status_pu8, (cmock_len * sizeof(*out_status_pu8)))

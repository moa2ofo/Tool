...
void ModuleName_FunctionEx__CMockExpectAndReturn(UNITY_UINT cmock_line, uint32_t in_id_u32, int32_t in_mode_e, const uint8_t *in_cfg_pcu8, uint8_t *in_buf_pu8, uint16_t in_bufLen_u16,
...
void ModuleName_FunctionEx__CMockExpectWithArrayAndReturn(UNITY_UINT cmock_line, uint32_t in_id_u32, int32_t in_mode_e, const uint8_t *in_cfg_pcu8, int in_cfg_pcu8_Depth, uint8_t *in_buf_pu8,
...
# 28 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
      ...
      UnityFail((((" Expected Non-NULL"))), (UNITY_UINT)(((28))));
    }
  } while(0);

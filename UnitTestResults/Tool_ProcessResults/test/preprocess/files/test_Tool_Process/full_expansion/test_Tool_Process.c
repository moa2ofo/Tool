...
# 14 "utExecutionAndResults/utUnderTest/src/Tool.h"
...
# 33 "utExecutionAndResults/utUnderTest/src/Tool.h"
...
void Tool_Init_CMockExpect(UNITY_UINT cmock_line);
...
void Tool_DeInit_CMockExpect(UNITY_UINT cmock_line);
...
void Tool_SetMode_u8_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);

void Tool_SetMode_u8_CMockStopIgnore(void);


void Tool_SetMode_u8_CMockExpectAnyArgsAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);


void Tool_SetMode_u8_CMockExpectAndReturn(UNITY_UINT cmock_line, Tool_mode_e mode, uint8_t cmock_to_return);
...
void Tool_SetMode_u8_CMockIgnoreArg_mode(UNITY_UINT cmock_line);


void Tool_GetStatus_u32_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint32_t cmock_to_return);

void Tool_GetStatus_u32_CMockStopIgnore(void);


void Tool_GetStatus_u32_CMockExpectAndReturn(UNITY_UINT cmock_line, uint32_t cmock_to_return);
...
void Tool_ComputeCrc_u32_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint32_t cmock_to_return);

void Tool_ComputeCrc_u32_CMockStopIgnore(void);


void Tool_ComputeCrc_u32_CMockExpectAnyArgsAndReturn(UNITY_UINT cmock_line, uint32_t cmock_to_return);


void Tool_ComputeCrc_u32_CMockExpectAndReturn(UNITY_UINT cmock_line, const uint8_t* data_pcu8, uint32_t length_u32, uint32_t cmock_to_return);
...
void Tool_ComputeCrc_u32_CMockExpectWithArrayAndReturn(UNITY_UINT cmock_line, const uint8_t* data_pcu8, int data_pcu8_Depth, uint32_t length_u32, uint32_t cmock_to_return);

void Tool_ComputeCrc_u32_CMockIgnoreArg_data_pcu8(UNITY_UINT cmock_line);

void Tool_ComputeCrc_u32_CMockIgnoreArg_length_u32(UNITY_UINT cmock_line);


void Tool_Push_u8_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);

void Tool_Push_u8_CMockStopIgnore(void);


void Tool_Push_u8_CMockExpectAnyArgsAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);


void Tool_Push_u8_CMockExpectAndReturn(UNITY_UINT cmock_line, uint8_t value_u8, uint8_t cmock_to_return);
...
void Tool_Push_u8_CMockIgnoreArg_value_u8(UNITY_UINT cmock_line);


void Tool_Pop_u8_CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);
...
void Tool_RunTst_u8_CMockExpectAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);
...
void ModuleName_FunctionEx__CMockIgnoreAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);

void ModuleName_FunctionEx__CMockStopIgnore(void);


void ModuleName_FunctionEx__CMockExpectAnyArgsAndReturn(UNITY_UINT cmock_line, uint8_t cmock_to_return);


void ModuleName_FunctionEx__CMockExpectAndReturn(UNITY_UINT cmock_line, uint32_t in_id_u32, int32_t in_mode_e, const uint8_t* in_cfg_pcu8, uint8_t* in_buf_pu8, uint16_t in_bufLen_u16, uint8_t* out_status_pu8, uint8_t cmock_to_return);
...
void ModuleName_FunctionEx__CMockExpectWithArrayAndReturn(UNITY_UINT cmock_line, uint32_t in_id_u32, int32_t in_mode_e, const uint8_t* in_cfg_pcu8, int in_cfg_pcu8_Depth, uint8_t* in_buf_pu8, int in_buf_pu8_Depth, uint16_t in_bufLen_u16, uint8_t* out_status_pu8, int out_status_pu8_Depth, uint8_t cmock_to_return);



void ModuleName_FunctionEx__CMockReturnMemThruPtr_in_buf_pu8(UNITY_UINT cmock_line, uint8_t const* in_buf_pu8, size_t cmock_size);



void ModuleName_FunctionEx__CMockReturnMemThruPtr_out_status_pu8(UNITY_UINT cmock_line, uint8_t const* out_status_pu8, size_t cmock_size);

void ModuleName_FunctionEx__CMockIgnoreArg_in_id_u32(UNITY_UINT cmock_line);

void ModuleName_FunctionEx__CMockIgnoreArg_in_mode_e(UNITY_UINT cmock_line);

void ModuleName_FunctionEx__CMockIgnoreArg_in_cfg_pcu8(UNITY_UINT cmock_line);

void ModuleName_FunctionEx__CMockIgnoreArg_in_buf_pu8(UNITY_UINT cmock_line);

void ModuleName_FunctionEx__CMockIgnoreArg_in_bufLen_u16(UNITY_UINT cmock_line);

void ModuleName_FunctionEx__CMockIgnoreArg_out_status_pu8(UNITY_UINT cmock_line);
...
# 9 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
...
# 23 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 3 4
 ((void *)0)
# 23 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
...
# 24 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 3 4
 ((void *)0)
# 24 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
...
# 25 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 3 4
 ((void *)0)
# 25 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
...
# 26 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 3 4
 ((void *)0)
# 26 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
...
# 27 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 3 4
 ((void *)0)
# 27 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
 ), (UNITY_UINT)(27), UNITY_DISPLAY_STYLE_UINT32);
  do { if ((((expectedBuf_pcu8)) != 
# 28 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 3 4
 ((void *)0)
# 28 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
 )) { } else { UnityFail( (((" Expected Non-NULL"))), (UNITY_UINT)(((28)))); } } while (0);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)(((64U))), (UNITY_INT)(UNITY_UINT32)((expectedBufLen_u32)), (
# 29 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 3 4
 ((void *)0)
# 29 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
...
# 32 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c" 3 4
   ((void *)0)
# 32 "utExecutionAndResults/utUnderTest/test/test_Tool_Process.c"
...
void test_Tool_Process_WhenRunModeWithData_ProcessesBuffer2(void) {
  ...
  for(uint32_t i = 0U; i < (64U); i++) {
    ...
    Tool_Pop_u8_CMockExpectAnyArgsAndReturn(55, 1U);
    Tool_Pop_u8_CMockReturnMemThruPtr_value_pu8(56, &popped, sizeof(uint8_t));
    Tool_Push_u8_CMockExpectAndReturn(57, expected, 0);
  }

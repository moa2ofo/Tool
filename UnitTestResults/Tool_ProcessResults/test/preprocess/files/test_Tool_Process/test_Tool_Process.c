...
static void Tool_AssertCheck(uint8_t expectedMode_e, uint32_t expectedCount_u32, uint32_t expectedHead_u32, uint32_t expectedTail_u32, uint32_t expectedStatusFlg_u32, const uint8_t *expectedBuf_pcu8,
                             uint32_t expectedBufLen_u32) {
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((expectedMode_e)), (UNITY_INT)(UNITY_UINT32)((Mode_e)), (((void *)0)), (UNITY_UINT)(23), UNITY_DISPLAY_STYLE_UINT32);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((expectedCount_u32)), (UNITY_INT)(UNITY_UINT32)((Count_u32)), (((void *)0)), (UNITY_UINT)(24), UNITY_DISPLAY_STYLE_UINT32);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((expectedHead_u32)), (UNITY_INT)(UNITY_UINT32)((Head_u32)), (((void *)0)), (UNITY_UINT)(25), UNITY_DISPLAY_STYLE_UINT32);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((expectedTail_u32)), (UNITY_INT)(UNITY_UINT32)((Tail_u32)), (((void *)0)), (UNITY_UINT)(26), UNITY_DISPLAY_STYLE_UINT32);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((expectedStatusFlg_u32)), (UNITY_INT)(UNITY_UINT32)((StatusFlg_u32)), (((void *)0)), (UNITY_UINT)(27), UNITY_DISPLAY_STYLE_UINT32);
  do {
  ...
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)(((64U))), (UNITY_INT)(UNITY_UINT32)((expectedBufLen_u32)), (((void *)0)), (UNITY_UINT)(29), UNITY_DISPLAY_STYLE_UINT32);

  for(uint32_t i = 0U; i < expectedBufLen_u32; i++) {
    UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT8)((expectedBuf_pcu8[i])), (UNITY_INT)(UNITY_UINT8)((Buffer_u8[i])), (((void *)0)), (UNITY_UINT)(32), UNITY_DISPLAY_STYLE_UINT8);
  }
}

...
void test_Tool_Process_WhenNotRunModeWithData_ProcessesBuffer2(void) {
  ...
  Tool_AssertCheck(Tool_modeIdle_e, 1U, 0U, 0U, 0U, l_Buffer_u8, TOOL_BUFFER_SIZE_U32);
}
...
void test_Tool_Process_WhenNotRunModeWithNoData_ProcessesBuffer2(void) {
  ...
  Tool_AssertCheck(Tool_modeIdle_e, 0U, 0U, 0U, 0U, l_Buffer_u8, TOOL_BUFFER_SIZE_U32);
}
...
void test_Tool_Process_WhenRunModeWithNoData_ProcessesBuffer2(void) {
  ...
  Tool_AssertCheck(Tool_modeRun_e, 0U, 0U, 0U, 0U, l_Buffer_u8, TOOL_BUFFER_SIZE_U32);
}

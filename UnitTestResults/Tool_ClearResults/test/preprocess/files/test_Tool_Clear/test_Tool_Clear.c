...
{ } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((71))); } } while (0);

  Tool_Clear();

  do { if (!((StatusFlg_u32 & (1U << 2U)) != 0U))
{ } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((77))); } } while (0);
}
...
{ } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((83))); } } while (0);

...
void Tool_Process(void) {
  ...
  if(!Mock.Tool_Process_CallbackBool && Mock.Tool_Process_CallbackFunctionPointer != NULL) {
...
void Tool_Process_CMockIgnore(void) { Mock.Tool_Process_IgnoreBool = (char)1; }

void Tool_Process_CMockStopIgnore(void) { Mock.Tool_Process_IgnoreBool = (char)0; }

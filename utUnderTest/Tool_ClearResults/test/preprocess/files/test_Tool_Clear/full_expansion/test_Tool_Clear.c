# 0 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c"
...
# 3 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c" 2
# 1 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Tool_Clear/mock_Tool.h" 1
...
# 6 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Tool_Clear/mock_Tool.h" 2
...
void Tool_Process_CMockExpect(UNITY_UINT cmock_line);
...
# 178 "utExecutionAndResults/utUnderTest/build/test/mocks/test_Tool_Clear/mock_Tool.h"
#pragma GCC diagnostic pop
# 4 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c" 2
...
# 7 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c" 2




# 10 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c"
void setUp(void) {
...
# 36 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c" 3 4
 ((void *)0)
# 36 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c"
 ), (UNITY_UINT)(36), UNITY_DISPLAY_STYLE_UINT32);
  UnityAssertEqualNumber((UNITY_INT)(UNITY_UINT32)((0U)), (UNITY_INT)(UNITY_UINT32)((Tail_u32)), (
# 37 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c" 3 4
 ((void *)0)
# 37 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c"
...
# 38 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c" 3 4
 ((void *)0)
# 38 "utExecutionAndResults/utUnderTest/test/test_Tool_Clear.c"
...
void test_Tool_Clear_ClearsOnlyErrorAndOverflowFlags(void) {
  ...
  do { if (((StatusFlg_u32 & (1U << 0U)) != 0U)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((97))); } } while (0);
  do { if (((StatusFlg_u32 & (1U << 1U)) != 0U)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((98))); } } while (0);
  do { if (((StatusFlg_u32 & (1U << 2U)) != 0U)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((99))); } } while (0);
  do { if (((StatusFlg_u32 & (1U << 3U)) != 0U)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((100))); } } while (0);


  Tool_Clear();


  do { if (((StatusFlg_u32 & (1U << 0U)) != 0U)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((106))); } } while (0);
  do { if (!((StatusFlg_u32 & (1U << 1U)) != 0U)) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((107))); } } while (0);
  do { if (!((StatusFlg_u32 & (1U << 2U)) != 0U)) { } else { UnityFail( ((" Expected FALSE Was TRUE")), (UNITY_UINT)((108))); } } while (0);
  do { if (((StatusFlg_u32 & (1U << 3U)) != 0U)) { } else { UnityFail( ((" Expected TRUE Was FALSE")), (UNITY_UINT)((109))); } } while (0);
}
